...
Assert-Contains $senderSource 'cmd.MissileMaxCountResv2 = effectiveTargetType == 0x66 ? 1 : 0;' 'Stimulus does not provision exactly one selected Resv2 slot'
Assert-Contains $senderSource 'cmd.MissileMaxCountResv1 = effectiveTargetType == 0x55 ? 1 : 0;' 'Stimulus 0x55 isolation was changed'
