...
$checks.Add((Add-Check "Stage5 MODTRAN radiance config defaults log-only" (($appSourceText -match "\[Stage5 ModtranRadianceConfig\]") -and ($appSourceText -match "EnableModtranRadianceDebug") -and ($appSourceText -match "UseModtranPathRuntime") -and ($appSourceText -match "defaultPathRadianceSource=legacy_empirical") -and ($appHeaderText -match "m_stage5UseModtranPathRuntime = false") -and ($appHeaderText -match "m_enableStage5ModtranRadianceDebug = true")) "$appHeader; $appSource")) | Out-Null
...
$checks.Add((Add-Check "Stage5 path component is explicit legacy/default and MODTRAN compare is log-only by default" (($radianceText -match "pathRadianceSource") -and ($radianceText -match "legacy_empirical|disabled") -and ($radianceText -match "modtranPathRadiance") -and ($appSourceText -match "UseModtranPathRuntime") -and ($appSourceText -match "modtranPathRuntimeAllowed") -and ($appSourceText -match "Stage3B log-only compare")) "$radianceHeader; $radianceSource; $appSource")) | Out-Null
