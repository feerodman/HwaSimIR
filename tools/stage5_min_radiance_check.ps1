...
$checks.Add((Add-Check "Stage5 MODTRAN radiance production default disables compare/runtime" (($appSourceText -match "\[Stage5 ModtranRadianceConfig\]") -and ($appSourceText -match "EnableModtranRadianceDebug") -and ($appSourceText -match "UseModtranPathRuntime") -and ($appSourceText -match "Stage5ModtranCompareEffective") -and ($appSourceText -match "defaultPathRadianceSource=legacy_empirical") -and ($appHeaderText -match "m_stage5UseModtranPathRuntime = false") -and ($appHeaderText -match "m_enableStage5ModtranRadianceDebug = false") -and ($appHeaderText -match "m_stage5ModtranCompareLegacy = false")) "$appHeader; $appSource")) | Out-Null
...
$checks.Add((Add-Check "Stage5 MODTRAN compare log is limited and explicit" (($appSourceText -match "\[Stage5 ModtranRadianceCompare\]") -and ($appSourceText -match "legacyPath=") -and ($appSourceText -match "modtranPath=") -and ($appSourceText -match "modtranSky=") -and ($appSourceText -match "modtranSolar=") -and ($appSourceText -match "fallbackReason=") -and ($appSourceText -match "interpolationMode=") -and ($appSourceText -match "m_stage5ModtranLogEveryFrames")) $appSource)) | Out-Null
