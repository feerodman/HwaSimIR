...
$modtranRadianceHeader = Join-Path $rootPath "HwaSim_IR\HwaSim_IR\IR\IRModtranRadianceLut.h"
$modtranRadianceSource = Join-Path $rootPath "HwaSim_IR\HwaSim_IR\IR\IRModtranRadianceLut.cpp"
...
$stage5ComponentsSmoke = Join-Path $rootPath "tools\stage5_radiance_components_smoke.ps1"
$stage5ModtranCompareSmoke = Join-Path $rootPath "tools\stage5_modtran_radiance_compare_smoke.ps1"
...
$modtranRadianceHeaderText = Read-Text $modtranRadianceHeader
$modtranRadianceSourceText = Read-Text $modtranRadianceSource
...
$modtranRadianceText = "$modtranRadianceHeaderText`n$modtranRadianceSourceText"
...
$checks.Add((Add-Check "Stage5 V2 exposes required inputs" (($radianceHeaderText -match "materialTemperatureK") -and ($radianceHeaderText -match "materialEmissivity") -and ($radianceHeaderText -match "materialReflectance") -and ($radianceHeaderText -match "tauUp") -and ($radianceHeaderText -match "solarStrength") -and ($radianceHeaderText -match "solarReflectanceWeight") -and ($radianceHeaderText -match "hotspotTemperatureK") -and ($radianceHeaderText -match "hotspotIntensity") -and ($radianceHeaderText -match "brightspotIntensity") -and ($radianceHeaderText -match "plumeRadiance") -and ($radianceHeaderText -match "legacyPathRadiance") -and ($radianceHeaderText -match "modtranPathRadiance") -and ($radianceHeaderText -match "modtranPathRaw") -and ($radianceHeaderText -match "modtranPathScaled") -and ($radianceHeaderText -match "effectivePathRadiance") -and ($radianceHeaderText -match "modtranSkyRadiance") -and ($radianceHeaderText -match "modtranSolarIrradiance") -and ($radianceHeaderText -match "pathRadianceSource") -and ($radianceHeaderText -match "sourceFlags")) $radianceHeader)) | Out-Null
$checks.Add((Add-Check "Stage5 V2 exposes required outputs" (($radianceHeaderText -match "IRRadianceComponents") -and ($radianceHeaderText -match "bodyRadiance") -and ($radianceHeaderText -match "reflectedRadiance") -and ($radianceHeaderText -match "rearHotspotRadiance") -and ($radianceHeaderText -match "plumeRadiance") -and ($radianceHeaderText -match "brightspotRadiance") -and ($radianceHeaderText -match "legacyPathRadiance") -and ($radianceHeaderText -match "modtranPathRadiance") -and ($radianceHeaderText -match "modtranPathRaw") -and ($radianceHeaderText -match "modtranPathScaled") -and ($radianceHeaderText -match "effectivePathRadiance") -and ($radianceHeaderText -match "modtranPathRuntimeMode") -and ($radianceHeaderText -match "modtranSkyRadiance") -and ($radianceHeaderText -match "modtranSolarIrradiance") -and ($radianceHeaderText -match "modtranRadianceValid") -and ($radianceHeaderText -match "modtranFallbackReason") -and ($radianceHeaderText -match "modtranInterpolationMode") -and ($radianceHeaderText -match "sensorInputLegacy") -and ($radianceHeaderText -match "sensorInputModtran") -and ($radianceHeaderText -match "sensorInputRadiance") -and ($radianceHeaderText -match "displayPreview") -and ($radianceHeaderText -match "pathRadianceSource") -and ($radianceHeaderText -match "finalRadianceDebug") -and ($radianceHeaderText -match "bodyGrayBeforeFloor") -and ($radianceHeaderText -match "bodyGrayAfterFloor") -and ($radianceHeaderText -match "reflectedGray") -and ($radianceHeaderText -match "hotspotGray") -and ($radianceHeaderText -match "brightspotGray") -and ($radianceHeaderText -match "finalGrayDebug") -and ($radianceHeaderText -match "debugFloorApplied")) $radianceHeader)) | Out-Null
...
$checks.Add((Add-Check "IRAeroThermalModel in VS/CMake project files" ((Test-TextContains $cmakePath "IR/IRAeroThermalModel\.cpp") -and (Test-TextContains $vcxprojPath "IR\\IRAeroThermalModel\.cpp") -and (Test-TextContains $vcxprojPath "IR\\IRAeroThermalModel\.h") -and (Test-TextContains $filtersPath "IR\\IRAeroThermalModel\.cpp") -and (Test-TextContains $filtersPath "IR\\IRAeroThermalModel\.h")) "$cmakePath; $vcxprojPath; $filtersPath")) | Out-Null
...
$checks.Add((Add-Check "IRModtranRadianceLut in CMake" (Test-TextContains $cmakePath "IR/IRModtranRadianceLut\.cpp") $cmakePath)) | Out-Null
$checks.Add((Add-Check "IRModtranRadianceLut in VS project" ((Test-TextContains $vcxprojPath "IR\\IRModtranRadianceLut\.cpp") -and (Test-TextContains $vcxprojPath "IR\\IRModtranRadianceLut\.h")) $vcxprojPath)) | Out-Null
$checks.Add((Add-Check "IRModtranRadianceLut in VS filters" ((Test-TextContains $filtersPath "IR\\IRModtranRadianceLut\.cpp") -and (Test-TextContains $filtersPath "IR\\IRModtranRadianceLut\.h")) $filtersPath)) | Out-Null
...
$checks.Add((Add-Check "Stage5 physical pipeline defaults on and DebugView defaults off" (($appSourceText -match "Stage5Radiance") -and ($appSourceText -match "EnableIRPhysicalPipeline") -and ($appSourceText -match "Stage5RadianceDebugView") -and ($appSourceText -match '"Off"') -and ($appSourceText -match "m_stage5DebugViewMode != 0") -and ($appHeaderText -match "m_enableStage5PhysicalPipeline = true") -and ($appHeaderText -match "m_enableStage5RadianceDebug = false")) "$appHeader; $appSource")) | Out-Null
...
$checks.Add((Add-Check "Stage5 startup logs physical pipeline config" (($appSourceText -match "\[Stage5 RadianceConfig\]") -and ($appSourceText -match "EnableIRPhysicalPipeline=") -and ($appSourceText -match "DebugView=") -and ($appSourceText -match "pathRadianceSource=legacy_empirical")) $appSource)) | Out-Null
$checks.Add((Add-Check "Stage5 MODTRAN radiance production default disables compare/runtime" (($appSourceText -match "\[Stage5 ModtranRadianceConfig\]") -and ($appSourceText -match "EnableModtranRadianceDebug") -and ($appSourceText -match "UseModtranPathRuntime") -and ($appSourceText -match "ModtranPathRuntimeMode") -and ($appSourceText -match "Stage5ModtranCompareEffective") -and ($appSourceText -match "defaultPathRadianceSource=legacy_empirical") -and ($appHeaderText -match "m_stage5UseModtranPathRuntime = false") -and ($appHeaderText -match "m_stage5ModtranPathRuntimeMode = `"Off`"") -and ($appHeaderText -match "m_enableStage5ModtranRadianceDebug = false") -and ($appHeaderText -match "m_stage5ModtranCompareLegacy = false")) "$appHeader; $appSource")) | Out-Null
$checks.Add((Add-Check "Stage5 aero thermal model is log-only by default" (($appSourceText -match "\[Stage5 AeroThermalConfig\]") -and ($appSourceText -match "EnableAeroThermalModel") -and ($appSourceText -match "ApplyAeroToRadiance") -and ($appSourceText -match "\[Stage5 AeroThermal\]") -and ($appSourceText -match "stage5AeroThermalMs") -and ($appHeaderText -match "m_stage5AeroThermalEnabled = true") -and ($appHeaderText -match "m_stage5ApplyAeroToRadiance = false") -and ($radianceText -match "bodyAeroDeltaK") -and ($radianceSourceText -match "aeroAppliedToRadiance")) "$appHeader; $appSource; $radianceHeader; $radianceSource")) | Out-Null
$checks.Add((Add-Check "IRModtranRadianceLut reads path sky solar fields" (($modtranRadianceText -match "path_radiance_band") -and ($modtranRadianceText -match "sky_radiance_band") -and ($modtranRadianceText -match "solar_irradiance_band") -and ($modtranRadianceText -match "nearest_neighbor") -and ($modtranRadianceText -match "invalid_geometry") -and ($modtranRadianceText -match "out_of_lut_range") -and ($modtranRadianceText -match "missing_band")) "$modtranRadianceHeader; $modtranRadianceSource")) | Out-Null
...
$checks.Add((Add-Check "Stage5 DebugView modes implemented" (($appSourceText -match "Off") -and ($appSourceText -match "Body") -and ($appSourceText -match "Reflected") -and ($appSourceText -match "RearHotspot") -and ($appSourceText -match "Plume") -and ($appSourceText -match "BrightSpot") -and ($appSourceText -match "Atmosphere") -and ($appSourceText -match "SensorInput") -and ($appSourceText -match "u_stage5_debug_view_mode == 1") -and ($appSourceText -match "u_stage5_debug_view_mode == 2") -and ($appSourceText -match "u_stage5_debug_view_mode == 3") -and ($appSourceText -match "u_stage5_debug_view_mode == 4") -and ($appSourceText -match "u_stage5_debug_view_mode == 5") -and ($appSourceText -match "u_stage5_debug_view_mode == 6")) $appSource)) | Out-Null
...
$checks.Add((Add-Check "Stage5 shader avoids MODTRAN path/sky/solar radiance tables" (($appSourceText -match "MODTRAN runtime disabled|does not use MODTRAN solar irradiance tables") -and ($appSourceText -match "u_stage5_path_radiance") -and ($appSourceText -notmatch "u_stage5_.*sky|u_stage5_solar_irradiance|solar_irradiance_band")) $appSource)) | Out-Null
$checks.Add((Add-Check "Stage5 logs required metrics" (($appSourceText -match "\[Stage5 RadianceComponents\]") -and ($appSourceText -match "sourceSeq=") -and ($appSourceText -match "targetID=") -and ($appSourceText -match "DebugView=") -and ($appSourceText -match "materialName=") -and ($appSourceText -match "materialTempK=") -and ($appSourceText -match "emissivity=") -and ($appSourceText -match "tauUp=") -and ($appSourceText -match "bodyRadiance=") -and ($appSourceText -match "reflectedRadiance=") -and ($appSourceText -match "rearHotspotRadiance=") -and ($appSourceText -match "plumeRadiance=") -and ($appSourceText -match "brightspotRadiance=") -and ($appSourceText -match "pathRadiance=") -and ($appSourceText -match "legacyPathRadiance=") -and ($appSourceText -match "modtranPathRadiance=") -and ($appSourceText -match "modtranSkyRadiance=") -and ($appSourceText -match "modtranSolarIrradiance=") -and ($appSourceText -match "pathRadianceSource=") -and ($appSourceText -match "sensorInputRadiance=") -and ($appSourceText -match "displayPreview=") -and ($appSourceText -match "sourceFlags=") -and ($appSourceText -match "stage5DisplayFallbackApplied=")) $appSource)) | Out-Null
$checks.Add((Add-Check "Stage5 aero thermal logs required metrics" (($appSourceText -match "\[Stage5 AeroThermal\]") -and ($appSourceText -match "altitudeM=") -and ($appSourceText -match "speedUnit=") -and ($appSourceText -match "speedMps=") -and ($appSourceText -match "airTempK=") -and ($appSourceText -match "speedOfSoundMps=") -and ($appSourceText -match "recoveryTempK=") -and ($appSourceText -match "bodyAeroDeltaK=") -and ($appSourceText -match "noseAeroDeltaK=") -and ($appSourceText -match "aeroAppliedToRadiance=")) $appSource)) | Out-Null
$checks.Add((Add-Check "Stage5 MODTRAN compare log is limited and explicit" (($appSourceText -match "\[Stage5 ModtranRadianceCompare\]") -and ($appSourceText -match "legacyPath=") -and ($appSourceText -match "modtranPathRaw=") -and ($appSourceText -match "modtranPathScaled=") -and ($appSourceText -match "modtranSky=") -and ($appSourceText -match "modtranSolar=") -and ($appSourceText -match "fallbackReason=") -and ($appSourceText -match "interpolationMode=") -and ($appSourceText -match "m_stage5ModtranLogEveryFrames")) $appSource)) | Out-Null
$checks.Add((Add-Check "Stage5 MODTRAN path runtime AB log is limited and explicit" (($appSourceText -match "\[Stage5 ModtranPathAB\]") -and ($appSourceText -match "sensorInputLegacy=") -and ($appSourceText -match "sensorInputModtran=") -and ($appSourceText -match "sensorInputEffective=") -and ($appSourceText -match "modtran_runtime_scaled") -and ($appSourceText -match "modtran_runtime_blend") -and ($appSourceText -match "fallback_legacy")) $appSource)) | Out-Null
...
$checks.Add((Add-Check "Stage5 physical components are separate from DebugView display" (($appSourceText -match "m_enableStage5PhysicalPipeline") -and ($appSourceText -match "m_stage5DebugViewMode != 0") -and ($appSourceText -match "u_stage5_radiance_debug_en") -and ($radianceSourceText -match "evaluateComponents") -and ($radianceSourceText -match "applyToneMap")) "$appSource; $radianceSource")) | Out-Null
...
$checks.Add((Add-Check "Stage5 path component is explicit legacy/default and MODTRAN compare is opt-in" (($radianceText -match "pathRadianceSource") -and ($radianceText -match "legacy_empirical|disabled") -and ($radianceText -match "modtranPathRadiance") -and ($appSourceText -match "UseModtranPathRuntime") -and ($appSourceText -match "modtranPathRuntimeAllowed") -and ($appSourceText -match "Stage5ModtranRadianceCompareEnabled")) "$radianceHeader; $radianceSource; $appSource")) | Out-Null
$checks.Add((Add-Check "runtime band fields are isolated to IRModtranRadianceLut loader" (($appSourceText -notmatch $forbiddenBandFields) -and ($radianceText -notmatch $forbiddenBandFields) -and ($modtranRadianceText -match $forbiddenBandFields)) "$appSource; $radianceHeader; $radianceSource; $modtranRadianceSource")) | Out-Null
...
$checks.Add((Add-Check "stage5 radiance components smoke script exists" (Test-Path -LiteralPath $stage5ComponentsSmoke -PathType Leaf) $stage5ComponentsSmoke)) | Out-Null
$checks.Add((Add-Check "stage5 MODTRAN radiance compare smoke script exists" (Test-Path -LiteralPath $stage5ModtranCompareSmoke -PathType Leaf) $stage5ModtranCompareSmoke)) | Out-Null
