...
$checks += Assert-Equals $ini "TcpOutput" "Codec" "auto" "auto"
...
$checks += Assert-True $ini "TcpOutput" "H264FallbackToJpeg" "true"
...
$checks += Assert-True $ini "TcpPayload" "SendVideo" "true"
$checks += Assert-True $ini "TcpPayload" "SendAnnotation" "true"
$checks += Assert-True $ini "TcpPayload" "SendRealtimeData" "true"
$checks += Assert-True $ini "TcpPayload" "ForwardInitControl" "true"
