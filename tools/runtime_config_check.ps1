...
$checks += Assert-Equals $ini "Stage5ModtranRadiance" "ModtranPathUnitMode" "SI" "SI"
...
$checks += Assert-True $ini "TcpOutput" "EnableH264Experimental" "true"
$checks += Assert-Equals $ini "TcpOutput" "Codec" "h264" "h264"
$checks += Assert-Equals $ini "TcpOutput" "H264Encoder" "auto" "auto"
$checks += Assert-Equals $ini "TcpOutput" "H264BitrateKbps" "4000" "4000"
$checks += Assert-Equals $ini "TcpOutput" "H264GopFrames" "30" "30"
$checks += Assert-True $ini "TcpOutput" "H264LowLatency" "true"
$checks += Assert-False $ini "TcpOutput" "H264FallbackToJpeg" "false"
$checks += Assert-True $ini "TcpOutput" "H264ForceKeyFrameOnStart" "true"
...
$checks += Assert-Equals $ini "TcpPayload" "PacketVersion" "3" "3"
$checks += Assert-False $ini "TcpPayload" "SendVideo" "false"
$checks += Assert-False $ini "TcpPayload" "SendAnnotation" "false"
$checks += Assert-False $ini "TcpPayload" "SendRealtimeData" "false"
$checks += Assert-False $ini "TcpPayload" "ForwardInitControl" "false"
...
$checks += Assert-True $ini "Stage5AeroThermal" "ApplyAeroToRadiance" "true"
...
$checks += Assert-Equals $ini "Stage5AeroThermal" "AeroApplyOnlyBand" "SWIR_MWIR" "SWIR_MWIR"
