...
{
    void on_subscription_matched(DataReader *reader, const SubscriptionMatchedStatus &status)
    {        
        ...
        //通过SubscriptionMatchedStatus可以获取匹配的数据读者的状态信息
...
int main(int argc, char** argv)
{
    ...
    DataReader* dr = sub->create_datareader(
        tp, DATAREADER_QOS_DEFAULT, &tlistener, SUBSCRIPTION_MATCHED_STATUS);
    if (dr == NULL)
    {
