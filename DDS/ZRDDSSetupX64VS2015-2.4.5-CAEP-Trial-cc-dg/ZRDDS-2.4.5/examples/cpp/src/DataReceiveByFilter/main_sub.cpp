...
int main(int argc, char** argv)
{
    ...
    ContentFilteredTopic* contentFilterTopic = dp->create_contentfilteredtopic(
        "contentFilterTopicName", tp, filter_exp, exp_para);
    ...
    DataReader* dr = sub->create_datareader(
        contentFilterTopic, DATAREADER_QOS_DEFAULT, &tlistener, DATA_AVAILABLE_STATUS);
    if (dr == NULL)
    {
